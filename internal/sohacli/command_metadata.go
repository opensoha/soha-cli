...
var topLevelCommandSpecs = []commandSpec{
	...
	},
	{
		...
		Summary: "Show or update AI client context headers",
		Subcommands: []commandSpec{
			{Name: "show", Usage: "soha context show [options]", Summary: "Show AI client context headers", Examples: []string{"soha context show"}},
			{Name: "set", Usage: "soha context set [options]", Summary: "Update AI client context headers", Examples: []string{"soha context set --skill-id k8s-sre --source codex"}},
		},
		Handler: runContext,
	},
	{
	...
	},
	{
		...
		Subcommands: []commandSpec{
			{Name: "search", Usage: "soha plugin search [options]", Summary: "Search plugin marketplace entries", Examples: []string{"soha plugin search --query k8s"}},
			{Name: "show", Usage: "soha plugin show [plugin-id] [options]", Summary: "Show marketplace, installed, or manifest details", Examples: []string{"soha plugin show opensoha.k8s-sre-pack --installed"}},
			{Name: "install", Usage: "soha plugin install [plugin-id] [options]", Summary: "Install a marketplace or manifest plugin", Examples: []string{"soha plugin install opensoha.k8s-sre-pack --enable"}},
			...
			{Name: "upgrade", Usage: "soha plugin upgrade <plugin-id> [options]", Summary: "Upgrade an installed plugin", Examples: []string{"soha plugin upgrade opensoha.k8s-sre-pack"}},
